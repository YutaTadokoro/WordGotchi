...
1. WHEN words are fed to the Gotchi THEN the System SHALL send the text to Claude API for emotion analysis
...
1. WHEN a Feeding Session completes AND the Gotchi is at Stage 2 or higher THEN the System SHALL generate abstract art using Stable Diffusion API
...
1. WHEN a Feeding Session completes AND the Gotchi is at Stage 2 or higher THEN the System SHALL generate poetry using Claude API
